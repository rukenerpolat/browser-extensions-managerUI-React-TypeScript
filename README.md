<h1 align="center">⚠️ This project is currently in progress ⚠️</h1>

<br>

<br>

<h1 align="center">Browser Extensions Manager UI</h1>
...
We provide the data for the extensions in a local `data.json` file.
