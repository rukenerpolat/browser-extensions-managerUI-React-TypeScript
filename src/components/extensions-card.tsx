    ...
    return (
        <div className="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-3">
            {extensions.map((extensions)=> (
                <article className="border border-neutral-200 dark:border-neutral-600 rounded-[1.25rem] 
                    p-5 bg-neutral-50 dark:bg-neutral-800 h-[200px] flex flex-col justify-between">
